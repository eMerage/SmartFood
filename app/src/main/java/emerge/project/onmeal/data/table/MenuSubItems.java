...
public class MenuSubItems extends RealmObject implements Serializable {
    ...
    public MenuSubItems(String menuCategory, int menuCategoryID, String menuTitle, int menuTitleID,
