 ...
 */
public class PersonlaizeAdapterType1 extends RecyclerView.Adapter<PersonlaizeAdapterType1.MyViewHolder> {

    Context mContext;
    ArrayList<MenuSubItems> menuSubItems;
    Realm realm;

    public PersonlaizeAdapterType1(Context mContext, ArrayList<MenuSubItems> item) {
