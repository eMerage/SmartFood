 ...
 */
public class PersonlaizeAdapterType5 extends RecyclerView.Adapter<PersonlaizeAdapterType5.MyViewHolder> {
    ...
    public PersonlaizeAdapterType5(Context mContext, ArrayList<MenuSubItems> item) {
...
/*
    ...
    public void addTypeTwo(MenuSubItems menusubItems, final MyViewHolder holder) {
        ...
        if (cartdetail.size() >= menusubItems.getMaxFreeItemQty()) {
            Toast.makeText(mContext, "Max other item count exceed", Toast.LENGTH_LONG).show();
            holder.checkBox.setChecked(false);
