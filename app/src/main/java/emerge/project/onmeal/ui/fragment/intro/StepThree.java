...
public class StepThree extends Fragment {
    ...
    public StepThree(FragmentActivityIntroView fragmentActivityIntroView) {
        fragmentActivityIntroPresenter = new FragmentActivityIntroPresenterImpli(fragmentActivityIntroView);
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_intro_stepthree, container, false);
    ...
    public void onClickNext(View view) {
        fragmentActivityIntroPresenter.setViewPagerStep(3);
