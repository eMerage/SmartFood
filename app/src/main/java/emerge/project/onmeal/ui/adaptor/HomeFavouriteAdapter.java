 ...
 */
public class HomeFavouriteAdapter extends RecyclerView.Adapter<HomeFavouriteAdapter.MyViewHolder> implements View.OnClickListener {
    ...
    public HomeFavouriteAdapter(Context mContext, ArrayList<HomeFavouriteItems> favouriteItem) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.listview_home_favorite, parent, false);
